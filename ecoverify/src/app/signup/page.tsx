...
export default function Home() {
  return (
    <>
    <div className="absolute md:m-auto md:my-[30vh] md:w-[411px] md:h-fit py-[3rem] md:rounded-[20px] left-0 right-0 bg-white  shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] z-10 flex flex-col md:gap-[1.664375rem] md:px-[2rem]">
      <div className="">
          <label className="w-[2.20125rem] text-black text-xs font-semibold font-['Fira Sans'] leading-[1.089375rem]">Company Name</label>
          <input className="w-full h-[31.37px] px-[10.46px] py-[6.97px] bg-white rounded-md border border-black/10 text-xs font-sans text-black font-[500]" placeholder="TheExampleCompany"></input>
      </div>
      <div className="">
      ...
      <div className="mx-auto w-[50%] flex flex-col p-0 gap-0 align-middle">
            <div className="w-[100%] lg:h-[41.91px] lg:p-[10.46px] bg-gradient-to-r from-[#032221] to-[#2cc295] lg:rounded-[6.97px] flex-col justify-center items-center inline-flex hover:brightness-90"><p className="text-white lg:text-sm font-semibold font-['Fira Sans'] lg:leading-[20.91px]">Sign-up</p></div>
